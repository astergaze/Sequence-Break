...
public class TextureAtlas
{
    ...
    //Adds the given animation to the texture atlas with the name
    public void AddAnimation(string animationName, Animation animation)
    {
        _animations.Add(animationName, animation);
    }

    //Gets the animation from this texture atlas with the name
    public Animation GetAnimation(string animationName)
    {
        return _animations[animationName];
    }

    //Removes the animation with the name from this atlas
    ...
    public static TextureAtlas FromFile(ContentManager content, string fileName)
    {
        ...
        using (Stream stream = TitleContainer.OpenStream(filePath))
        {
            using (XmlReader reader = XmlReader.Create(stream))
            {
                ...
                //The animations element contains individual animation elements, each one a different animation in the atlas
                // Example:
                // <Animations>
    ...
    //Creates a new animated sprite using the animation from this texture atlas with the name
